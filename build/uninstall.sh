...
remove_line "$PROJLINE" ~/.bashrc
remove_line "$PROJLINE" ~/.vimrc
remove_line "$PROJLINE" ~/.screenrc
if $CONFIG_DESKTOP; then
	remove_line "$PROJLINE" ~/.Xdefaults
fi
...
test -f "$CONFIG_VROOT/version" && rm "$CONFIG_VROOT/version"
